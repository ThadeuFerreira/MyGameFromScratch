...
set CommonCompilerFlags=-MTd -nologo -Gm- -GR- -EHa- -Od -Oi -WX -W4 -wd4201 -wd4100 -wd4189 -DHANDMADE_INTERNAL=1 -DHANDMADE_DEBUG_SOUND -DHANDMADE_SLOW=1 -DHANDMADE_WIN32=1 -FC -Z7
